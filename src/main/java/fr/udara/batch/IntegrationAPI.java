...
public class IntegrationAPI {
	...
	public static void traite() throws Exception {
		...
		String url_Meteo = "https://api.openweathermap.org/data/2.5/weather?q=" + city_name + "&appid=" + API_key + "&units="
				+ metrics;
		...
		String url_Indicateur = "http://api.openweathermap.org/data/2.5/air_pollution?lat=" + bean.getLatitude() + "&lon="
				+ bean.getLongitude() + "&appid=" + API_key;
